<template>
  ...
  >
    <div>
      ...
      <!-- image diplay -->
      <div class="entry image" style="border-radius: 5px; height: 125px; position: relative;" v-for="entry in reverseImages" :key="entry.index">
        <img style="border-radius: 5px; height: 100%;" :src="entry.img.path">
        <div class="entry image display label" style="height: fit-content;" @click.prevent="deleteImage(entry.index)">
          <svg style="height: 12px; padding: 0; margin: 0; margin-left: -7px;" class="icon_" width="512" height="512" viewBox="0 0 512 512"><path d="M448 64h-96V0H159.9l.066 64H32v32h32v416h384V96h32V64h-32zM192 32h128v32H192V32zm224 448H96V96h320v384zM192 160h32v256h-32V160zm96 0h32v256h-32V160z"></path></svg>
          <label class="text" style="font-size: x-small; margin-left: -7px; cursor: pointer; color: white; font-weight: 50;">Bild entfernen</label>
        </div>
      </div>
...
export default {
  ...
  methods: {
    ...
    createImage (file) {
      ...
      if (this.maxImage - 1 <= this.images.length) {
